...
#[test]
fn net_filter_ipv6_multicast_ff12_slash16_with_help() {
    let output = cargo_bin()
        .args(["--net-filter", "ff12::/16", "-h"])
        .output()
        .unwrap();
    assert!(output.status.success());
}
...
#[test]
fn net_filter_ipv6_multicast_ff13_slash16_with_help() {
    let output = cargo_bin()
        .args(["-F", "ff13::/16", "-h"])
        .output()
        .unwrap();
...
#[test]
fn net_filter_ipv6_multicast_ff14_slash16_with_help() {
    let output = cargo_bin()
        .args(["--net-filter", "ff14::/16", "-h"])
        .output()
        .unwrap();
    assert!(output.status.success());
}
...
#[test]
fn net_filter_ipv6_multicast_ff15_slash16_with_help() {
    let output = cargo_bin()
        .args(["-F", "ff15::/16", "-h"])
        .output()
        .unwrap();
...
#[test]
fn net_filter_ipv6_multicast_ff16_slash16_with_help() {
    let output = cargo_bin()
        .args(["--net-filter", "ff16::/16", "-h"])
        .output()
        .unwrap();
    assert!(output.status.success());
}
...
#[test]
fn net_filter_ipv6_multicast_ff17_slash16_with_help() {
    let output = cargo_bin()
        .args(["-F", "ff17::/16", "-h"])
        .output()
        .unwrap();
...
#[test]
fn net_filter_ipv6_multicast_ff18_slash16_with_help() {
    let output = cargo_bin()
        .args(["--net-filter", "ff18::/16", "-h"])
        .output()
        .unwrap();
    assert!(output.status.success());
}
...
#[test]
fn net_filter_ipv6_multicast_ff19_slash16_with_help() {
    let output = cargo_bin()
        .args(["-F", "ff19::/16", "-h"])
        .output()
        .unwrap();
...
#[test]
fn net_filter_ipv6_multicast_ff1a_slash16_with_help() {
    let output = cargo_bin()
        .args(["--net-filter", "ff1a::/16", "-h"])
        .output()
        .unwrap();
    assert!(output.status.success());
}
...
#[test]
fn net_filter_ipv6_multicast_ff1b_slash16_with_help() {
    let output = cargo_bin()
        .args(["-F", "ff1b::/16", "-h"])
        .output()
        .unwrap();
...
#[test]
fn net_filter_ipv6_multicast_ff1c_slash16_with_help() {
    let output = cargo_bin()
        .args(["--net-filter", "ff1c::/16", "-h"])
        .output()
        .unwrap();
    assert!(output.status.success());
}
...
#[test]
fn net_filter_ipv6_multicast_ff1d_slash16_with_help() {
    let output = cargo_bin()
        .args(["-F", "ff1d::/16", "-h"])
        .output()
        .unwrap();
...
#[test]
fn net_filter_ipv6_multicast_ff1e_slash16_with_help() {
    let output = cargo_bin()
        .args(["--net-filter", "ff1e::/16", "-h"])
        .output()
        .unwrap();
    assert!(output.status.success());
}
...
#[test]
fn net_filter_ipv6_multicast_ff1f_slash16_with_help() {
    let output = cargo_bin()
        .args(["-F", "ff1f::/16", "-h"])
        .output()
        .unwrap();
...
#[test]
fn net_filter_ipv6_multicast_ff22_slash16_with_help() {
    let output = cargo_bin()
        .args(["--net-filter", "ff22::/16", "-h"])
        .output()
        .unwrap();
    assert!(output.status.success());
}
...
#[test]
fn net_filter_ipv6_multicast_ff23_slash16_with_help() {
    let output = cargo_bin()
        .args(["-F", "ff23::/16", "-h"])
        .output()
        .unwrap();
...
#[test]
fn net_filter_ipv6_multicast_ff24_slash16_with_help() {
    let output = cargo_bin()
        .args(["--net-filter", "ff24::/16", "-h"])
        .output()
        .unwrap();
    assert!(output.status.success());
}
...
#[test]
fn net_filter_ipv6_multicast_ff25_slash16_with_help() {
    let output = cargo_bin()
        .args(["-F", "ff25::/16", "-h"])
        .output()
        .unwrap();
...
#[test]
fn net_filter_ipv6_multicast_ff26_slash16_with_help() {
    let output = cargo_bin()
        .args(["--net-filter", "ff26::/16", "-h"])
        .output()
        .unwrap();
    assert!(output.status.success());
}
...
#[test]
fn net_filter_ipv6_multicast_ff27_slash16_with_help() {
    let output = cargo_bin()
        .args(["-F", "ff27::/16", "-h"])
        .output()
        .unwrap();
...
#[test]
fn net_filter_ipv6_multicast_ff28_slash16_with_help() {
    let output = cargo_bin()
        .args(["--net-filter", "ff28::/16", "-h"])
        .output()
        .unwrap();
    assert!(output.status.success());
}
...
#[test]
fn net_filter_ipv6_multicast_ff29_slash16_with_help() {
    let output = cargo_bin()
        .args(["-F", "ff29::/16", "-h"])
        .output()
        .unwrap();
...
#[test]
fn net_filter_ipv6_multicast_ff2a_slash16_with_help() {
    let output = cargo_bin()
        .args(["--net-filter", "ff2a::/16", "-h"])
        .output()
        .unwrap();
    assert!(output.status.success());
}
...
#[test]
fn net_filter_ipv6_multicast_ff2b_slash16_with_help() {
    let output = cargo_bin()
        .args(["-F", "ff2b::/16", "-h"])
        .output()
        .unwrap();
...
#[test]
fn net_filter_ipv6_multicast_ff2c_slash16_with_help() {
    let output = cargo_bin()
        .args(["--net-filter", "ff2c::/16", "-h"])
        .output()
        .unwrap();
    assert!(output.status.success());
}
...
#[test]
fn net_filter_ipv6_multicast_ff2d_slash16_with_help() {
    let output = cargo_bin()
        .args(["-F", "ff2d::/16", "-h"])
        .output()
        .unwrap();
...
#[test]
fn net_filter_ipv6_multicast_ff2e_slash16_with_help() {
    let output = cargo_bin()
        .args(["--net-filter", "ff2e::/16", "-h"])
        .output()
        .unwrap();
    assert!(output.status.success());
}
...
#[test]
fn net_filter_ipv6_multicast_ff2f_slash16_with_help() {
    let output = cargo_bin()
        .args(["-F", "ff2f::/16", "-h"])
        .output()
        .unwrap();
...
#[test]
fn net_filter_ipv6_multicast_ff30_slash16_with_help() {
    let output = cargo_bin()
        .args(["--net-filter", "ff30::/16", "-h"])
        .output()
        .unwrap();
    assert!(output.status.success());
}
...
#[test]
fn net_filter_ipv6_multicast_ff31_slash16_with_help() {
    let output = cargo_bin()
        .args(["-F", "ff31::/16", "-h"])
        .output()
        .unwrap();
...
#[test]
fn net_filter_ipv6_multicast_ff32_slash16_with_help() {
    let output = cargo_bin()
        .args(["--net-filter", "ff32::/16", "-h"])
        .output()
        .unwrap();
    assert!(output.status.success());
}
...
#[test]
fn net_filter_ipv6_multicast_ff33_slash16_with_help() {
    let output = cargo_bin()
        .args(["-F", "ff33::/16", "-h"])
        .output()
        .unwrap();
...
#[test]
fn net_filter_ipv6_multicast_ff34_slash16_with_help() {
    let output = cargo_bin()
        .args(["--net-filter", "ff34::/16", "-h"])
        .output()
        .unwrap();
    assert!(output.status.success());
}
...
#[test]
fn net_filter_ipv6_multicast_ff35_slash16_with_help() {
    let output = cargo_bin()
        .args(["-F", "ff35::/16", "-h"])
        .output()
        .unwrap();
...
#[test]
fn net_filter_ipv6_multicast_ff36_slash16_with_help() {
    let output = cargo_bin()
        .args(["--net-filter", "ff36::/16", "-h"])
        .output()
        .unwrap();
    assert!(output.status.success());
}
...
#[test]
fn net_filter_ipv6_multicast_ff37_slash16_with_help() {
    let output = cargo_bin()
        .args(["-F", "ff37::/16", "-h"])
        .output()
        .unwrap();
...
#[test]
fn net_filter_ipv6_multicast_ff38_slash16_with_help() {
    let output = cargo_bin()
        .args(["--net-filter", "ff38::/16", "-h"])
        .output()
        .unwrap();
    assert!(output.status.success());
}
...
#[test]
fn net_filter_ipv6_multicast_ff39_slash16_with_help() {
    let output = cargo_bin()
        .args(["-F", "ff39::/16", "-h"])
        .output()
        .unwrap();
...
#[test]
fn net_filter_ipv6_multicast_ff3a_slash16_with_help() {
    let output = cargo_bin()
        .args(["--net-filter", "ff3a::/16", "-h"])
        .output()
        .unwrap();
    assert!(output.status.success());
}
...
#[test]
fn net_filter_ipv6_multicast_ff3b_slash16_with_help() {
    let output = cargo_bin()
        .args(["-F", "ff3b::/16", "-h"])
        .output()
        .unwrap();
...
#[test]
fn net_filter_ipv6_multicast_ff3c_slash16_with_help() {
    let output = cargo_bin()
        .args(["--net-filter", "ff3c::/16", "-h"])
        .output()
        .unwrap();
    assert!(output.status.success());
}
...
#[test]
fn net_filter_ipv6_multicast_ff3d_slash16_with_help() {
    let output = cargo_bin()
        .args(["-F", "ff3d::/16", "-h"])
        .output()
        .unwrap();
...
#[test]
fn net_filter_ipv6_multicast_ff3e_slash16_with_help() {
    let output = cargo_bin()
        .args(["--net-filter", "ff3e::/16", "-h"])
        .output()
        .unwrap();
    assert!(output.status.success());
}
...
#[test]
fn net_filter_ipv6_multicast_ff3f_slash16_with_help() {
    let output = cargo_bin()
        .args(["-F", "ff3f::/16", "-h"])
        .output()
        .unwrap();
...
#[test]
fn net_filter_ipv6_multicast_ff40_slash16_with_help() {
    let output = cargo_bin()
        .args(["--net-filter", "ff40::/16", "-h"])
        .output()
        .unwrap();
    assert!(output.status.success());
}
...
#[test]
fn net_filter_ipv6_multicast_ff41_slash16_with_help() {
    let output = cargo_bin()
        .args(["-F", "ff41::/16", "-h"])
        .output()
        .unwrap();
...
#[test]
fn net_filter_ipv6_multicast_ff42_slash16_with_help() {
    let output = cargo_bin()
        .args(["--net-filter", "ff42::/16", "-h"])
        .output()
        .unwrap();
    assert!(output.status.success());
}
...
#[test]
fn net_filter_ipv6_multicast_ff43_slash16_with_help() {
    let output = cargo_bin()
        .args(["-F", "ff43::/16", "-h"])
        .output()
        .unwrap();
...
#[test]
fn net_filter_ipv6_multicast_ff44_slash16_with_help() {
    let output = cargo_bin()
        .args(["--net-filter", "ff44::/16", "-h"])
        .output()
        .unwrap();
    assert!(output.status.success());
}
...
#[test]
fn net_filter_ipv6_multicast_ff45_slash16_with_help() {
    let output = cargo_bin()
        .args(["-F", "ff45::/16", "-h"])
        .output()
        .unwrap();
...
#[test]
fn net_filter_ipv6_multicast_ff46_slash16_with_help() {
    let output = cargo_bin()
        .args(["--net-filter", "ff46::/16", "-h"])
        .output()
        .unwrap();
    assert!(output.status.success());
}
...
#[test]
fn net_filter_ipv6_multicast_ff47_slash16_with_help() {
    let output = cargo_bin()
        .args(["-F", "ff47::/16", "-h"])
        .output()
        .unwrap();
...
#[test]
fn net_filter_ipv6_multicast_ff48_slash16_with_help() {
    let output = cargo_bin()
        .args(["--net-filter", "ff48::/16", "-h"])
        .output()
        .unwrap();
    assert!(output.status.success());
}
...
#[test]
fn net_filter_ipv6_multicast_ff49_slash16_with_help() {
    let output = cargo_bin()
        .args(["-F", "ff49::/16", "-h"])
        .output()
        .unwrap();
...
#[test]
fn net_filter_ipv4_private_class_b_172_26_slash16_with_help() {
    let output = cargo_bin()
        .args(["--net-filter", "172.26.0.0/16", "-h"])
        .output()
        .unwrap();
    assert!(output.status.success());
}
...
#[test]
fn net_filter_ipv4_private_class_c_192_168_128_slash17_with_help() {
    let output = cargo_bin()
        .args(["-F", "192.168.128.0/17", "-h"])
        .output()
        .unwrap();
    assert!(output.status.success());
}
...
#[test]
fn net_filter_ipv4_private_class_b_172_27_slash16_with_help() {
    let output = cargo_bin()
        .args(["--net-filter", "172.27.0.0/16", "-h"])
        .output()
        .unwrap();
    assert!(output.status.success());
}
...
#[test]
fn net_filter_ipv4_private_class_b_172_28_slash16_with_help() {
    let output = cargo_bin()
        .args(["-F", "172.28.0.0/16", "-h"])
        .output()
        .unwrap();
    assert!(output.status.success());
}
...
#[test]
fn net_filter_ipv4_private_class_a_10_slash13_with_help() {
    let output = cargo_bin()
        .args(["--net-filter", "10.0.0.0/13", "-h"])
        .output()
        .unwrap();
    assert!(output.status.success());
}
...
#[test]
fn net_filter_ipv4_private_class_a_10_slash14_with_help() {
    let output = cargo_bin()
        .args(["-F", "10.0.0.0/14", "-h"])
        .output()
        .unwrap();
    assert!(output.status.success());
}
