...
mod tests {
    ...
    #[test]
    fn parse_net_filter_combining_latin_small_letter_h_after_prefix_returns_none() {
        let args = args_with_net_filter("10.0.0.0/24\u{036A}");
        assert!(args.parse_net_filter().is_none());
    }

    #[test]
    fn parse_net_filter_combining_latin_small_letter_m_after_prefix_returns_none() {
        let args = args_with_net_filter("10.0.0.0/24\u{036B}");
        assert!(args.parse_net_filter().is_none());
    }

    #[test]
    fn parse_net_filter_combining_latin_small_letter_r_after_prefix_returns_none() {
        let args = args_with_net_filter("10.0.0.0/24\u{036C}");
        assert!(args.parse_net_filter().is_none());
    }

    #[test]
    fn parse_net_filter_combining_latin_small_letter_t_after_prefix_returns_none() {
        let args = args_with_net_filter("10.0.0.0/24\u{036D}");
        assert!(args.parse_net_filter().is_none());
    }

    #[test]
    fn parse_net_filter_combining_latin_small_letter_v_after_prefix_returns_none() {
        let args = args_with_net_filter("10.0.0.0/24\u{036E}");
        assert!(args.parse_net_filter().is_none());
    }

    #[test]
    fn parse_net_filter_combining_latin_small_letter_x_after_prefix_returns_none() {
        let args = args_with_net_filter("10.0.0.0/24\u{036F}");
        assert!(args.parse_net_filter().is_none());
    }

    #[test]
    fn parse_net_filter_greek_capital_letter_heta_after_prefix_returns_none() {
        let args = args_with_net_filter("10.0.0.0/24\u{0370}");
        assert!(args.parse_net_filter().is_none());
    }

    #[test]
    fn parse_net_filter_greek_small_letter_heta_after_prefix_returns_none() {
        let args = args_with_net_filter("10.0.0.0/24\u{0371}");
        assert!(args.parse_net_filter().is_none());
    }

    #[test]
    fn parse_net_filter_greek_capital_letter_archaic_sampi_after_prefix_returns_none() {
        let args = args_with_net_filter("10.0.0.0/24\u{0372}");
        assert!(args.parse_net_filter().is_none());
    }

    #[test]
    fn parse_net_filter_greek_small_letter_archaic_sampi_after_prefix_returns_none() {
        let args = args_with_net_filter("10.0.0.0/24\u{0373}");
        assert!(args.parse_net_filter().is_none());
    }

    #[test]
    fn parse_net_filter_greek_numeral_sign_after_prefix_returns_none() {
        let args = args_with_net_filter("10.0.0.0/24\u{0374}");
        assert!(args.parse_net_filter().is_none());
    }

    #[test]
    fn parse_net_filter_greek_lower_numeral_sign_after_prefix_returns_none() {
        let args = args_with_net_filter("10.0.0.0/24\u{0375}");
        assert!(args.parse_net_filter().is_none());
    }

    #[test]
    fn parse_net_filter_greek_capital_letter_pamphylian_digamma_after_prefix_returns_none() {
        let args = args_with_net_filter("10.0.0.0/24\u{0376}");
        assert!(args.parse_net_filter().is_none());
    }

    #[test]
    fn parse_net_filter_greek_small_letter_pamphylian_digamma_after_prefix_returns_none() {
        let args = args_with_net_filter("10.0.0.0/24\u{0377}");
        assert!(args.parse_net_filter().is_none());
    }

    #[test]
    fn parse_net_filter_greek_ypogegrammeni_u037a_after_prefix_returns_none() {
    ...
    #[test]
    fn parse_net_filter_greek_capital_letter_eta_with_tonos_after_prefix_returns_none() {
        let args = args_with_net_filter("10.0.0.0/24\u{0389}");
        assert!(args.parse_net_filter().is_none());
    }

    #[test]
    fn parse_net_filter_greek_capital_letter_iota_with_tonos_after_prefix_returns_none() {
        let args = args_with_net_filter("10.0.0.0/24\u{038A}");
        assert!(args.parse_net_filter().is_none());
    }

    #[test]
    fn parse_net_filter_greek_capital_letter_omicron_with_tonos_after_prefix_returns_none() {
        let args = args_with_net_filter("10.0.0.0/24\u{038C}");
        assert!(args.parse_net_filter().is_none());
    }

    #[test]
    fn parse_net_filter_greek_capital_letter_upsilon_with_tonos_after_prefix_returns_none() {
        let args = args_with_net_filter("10.0.0.0/24\u{038E}");
        assert!(args.parse_net_filter().is_none());
    }

    #[test]
    fn parse_net_filter_greek_capital_letter_omega_with_tonos_after_prefix_returns_none() {
        let args = args_with_net_filter("10.0.0.0/24\u{038F}");
        assert!(args.parse_net_filter().is_none());
    }
    ...
    #[test]
    fn parse_net_filter_greek_capital_letter_alpha_after_prefix_returns_none() {
        let args = args_with_net_filter("10.0.0.0/24\u{0391}");
        assert!(args.parse_net_filter().is_none());
    }

    #[test]
    fn parse_net_filter_greek_capital_letter_beta_after_prefix_returns_none() {
        let args = args_with_net_filter("10.0.0.0/24\u{0392}");
        assert!(args.parse_net_filter().is_none());
    }

    #[test]
    fn parse_net_filter_greek_capital_letter_gamma_after_prefix_returns_none() {
        let args = args_with_net_filter("10.0.0.0/24\u{0393}");
        assert!(args.parse_net_filter().is_none());
    }

    #[test]
    fn parse_net_filter_greek_capital_letter_delta_after_prefix_returns_none() {
        let args = args_with_net_filter("10.0.0.0/24\u{0394}");
        assert!(args.parse_net_filter().is_none());
    }
}
